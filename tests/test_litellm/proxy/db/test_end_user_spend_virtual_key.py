...
async def _call_update_database(
    ...
    with ExitStack() as stack:
        ...
        # Flush background tasks created by asyncio.create_task() inside
        # update_database (e.g. _batch_database_updates) so the mocked
        # methods are invoked before we assert on them.
